...
public class CourseTest {
	...
	private Course setupClass() throws ParseException {
		...
		CS510Offerings.add(new CourseOffering("300", new SimpleDateFormat(
				"MM/dd/yyyy", Locale.ENGLISH).parse("01/14/2014"),
				new SimpleDateFormat("MM/dd/yyyy", Locale.ENGLISH)
						.parse("05/23/2014"), 25, null, null));

		CS510Offerings.add(new CourseOffering("400", new SimpleDateFormat(
				"MM/dd/yyyy", Locale.ENGLISH).parse("05/13/2014"),
				new SimpleDateFormat("MM/dd/yyyy", Locale.ENGLISH)
						.parse("09/23/2014"), 30, null, null));
		...
		Course test = new Course(
				...
				"Computer Science", CS510Offerings);

		return test;
	}

	@Test
	public void testCourseStringStringIntStringStringArrayListOfCourseOffering()
	...
	public void testCourseString() {
		Course test = new Course(
				"123,Class of Something,532,A class about something,Something Department");
	}
	...
	public void testCourseStringException1() {
		...
		Course test = new Course(
				"123,Class of Something,532,A class about something");
	}
	...
	public void testCourseStringException2() {
		// Too many parameters
		Course test = new Course(
				"123,Class of Something,532,A class about something,Something Department,1");
	}
	...
	public void testCourseStringException3() {
		// Wrong type
		Course test = new Course(
				"123,Class of Something,Wrong Type,A class about something,Something Department");
	}
	...
	public void testWriteln() {
		...
		assertTrue(test
				.writeln()
				.compareTo(
						"123,Class of Something,532,A class about something,Something Department") == 0);
	}
